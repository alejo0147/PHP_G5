    ...
    <body>
        <header class="banner-politicas">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="tagline">Lista de Maquinas</h1>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="col-sm-10"><br />
                    <table class="table table-bordered">
                        <thead style="background-color: #31B0D5">
                            <tr>
                                <th scope="col">TIPO MAQUINA</th>
                                <th scope="col">REFERENCIA</th>
                                <th scope="col">SERIAL</th>
                                <th scope="col">FECH DE INGRESO</th>
                        ...
                        <tbody style="background-color: #BAE4F1">
                            <?php
                                    ...
                                    $sql = "SELECT tipoMaquina,referencia,serial,fechaIngreso,estado FROM maquinaria";
                        ...
                        <form action="../Controladores/usuarioControlador.php" method="post" class="form-login">
                            <div class="form-col">
                                <div class="col-md-2" style="text-align: center;">
                                    <label for="validationDefault01">N° Serial</label><br />
                                    <input type="text" class="form-control" id="validationDefault01" placeholder="N° de Serie" name="nSerial" required/><br />
                                    <button type="submit" class="btn btn-danger btn-lg" name="btnDardeBajaMaquina" style="width: 170px;">Cambiar Estado</button>
                                </div>
                            </div>
                        </form>
                    </div>  
        ...
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <input class="btn btn-info" type="button" value="Nuevo" onClick="window.location.href = 'registroMaquina.php'"/>
        </div>
