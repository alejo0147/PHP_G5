    ...
    <form class="formularioRegGerentes" action="../Controladores/usuarioControlador.php" method="POST">
        <header class="banner-administracion">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="tagline">Crear Gerentes</h1>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6"><br />
                    ...
                    <input id="validationDefault02" name="nombreGerente" placeholder=" Ingrese Nombres" title="Nombres"  style="width:350px;font-size:15px;border-radius: 4px" REQUIRED/><br /><br />
                    <label for="validationDefault03" style="color: #71A7AA">APELLIDOS</label><br />
                    <input id="validationDefault03" name="apellidosGerente" placeholder=" Ingrese Apellidos" title="Apellidos" style="width:350px;font-size:15px;border-radius: 4px" REQUIRED/><br /><br />
                </div>
                <div class="col-sm-6"><br />
                    <label for="inputEmail3" style="color: #71A7AA">CORREO</label><br />
                    <input id="inputEmail3" name="correoGerente" placeholder=" Ingrese Correo" title="Email"  style="width:350px;font-size:15px;border-radius: 4px"style="width:150px;font-size:15px;border-radius: 4px" REQUIRED/><br /><br />
                    <label for="inputPassword5" style="color: #71A7AA">CLAVE</label><br />
                    <input id="inputPassword5" name="passGerente" type="password" maxlength="10" placeholder=" Ingrese Clave" title="Clave"  style="width:150px;font-size:15px;border-radius: 4px" REQUIRED/><br /><br />
                    <label for="inlineFormCustomSelectPref" style="color: #71A7AA">CONTRATO</label><br />
                    <select id="inlineFormCustomSelectPref" name="tipoContratoGerente"  title="Contrato"  style="width:150px;font-size:15px;border-radius: 4px" REQUIRED>
        ...
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input class="btn btn-primary" type="submit" name="btnRegistrarGerente" value="Guardar"/>&nbsp;&nbsp;
