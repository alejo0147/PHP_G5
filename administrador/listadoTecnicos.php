    ...
    <body>
        <header class="banner-tecnicos">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="tagline">Lista de Técnicos</h1>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <form action="../Controladores/usuarioControlador.php" method="post" class="form-login">
                            <div class="form-col">
                                <div class="col-md-2" style="text-align: center;">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-lg" name="btnCambEstadoTecnico" style="width: 170px;">Cambiar Estado</button>
                                </div>
                            </div>
                        </form>
                    </div>  
        ...
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <input class="btn btn-info" type="button" value="Nuevo" onClick="window.location.href = 'registroTecnicos.php'"/>
        </div>
